...
function styles() {
    return src(['app/css/sanitize.css',
        'app/' + preprocessor + '/styles.' + preprocessor + '']) // Выбираем источник: "app/sass/main.sass" или "app/less/main.less"
...
function startwatch() {
    ...
    watch(['app/**/*.js', '!app/**/*.min.js'], series([scripts, buildcopy]));

    // Мониторим файлы препроцессора на изменения
    watch('app/**/' + preprocessor + '/**/*', series([styles, buildcopy]));

    // Мониторим файлы HTML на изменения
    watch('app/**/*.html').on('change', series([buildcopy, browserSync.reload]));

    // Мониторим папку-источник изображений и выполняем images(), если есть изменения
    watch('app/img/src/**/*', series([images, buildcopy]));
